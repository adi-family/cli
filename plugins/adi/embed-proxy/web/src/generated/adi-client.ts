...
export const createToken = (c: Connection, params: { name: string; key_mode: KeyMode; upstream_key_id?: string; platform_provider?: ProviderType; allowed_models?: string[]; blocked_models?: string[]; log_requests?: boolean; log_responses?: boolean; expires_at?: string; }) =>
  c.request<CreateTokenResponse>(SVC, 'create_token', params);

export const updateToken = (c: Connection, params: { id: string; name?: string; allowed_models?: string[]; blocked_models?: string[]; log_requests?: boolean; log_responses?: boolean; is_active?: boolean; expires_at?: string; }) =>
