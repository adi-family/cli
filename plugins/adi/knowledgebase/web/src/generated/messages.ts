...
export type SignalingMessage =
  // ── adi.knowledgebase ──
  | { type: 'adi.knowledgebase_create_node'; title: string; content: string; node_type: NodeType; source: string; metadata?: Record<string, unknown> }
  | { type: 'adi.knowledgebase_create_node_response'; id: string; node_type: NodeType; title: string; content: string; source: string; approval_status: ApprovalStatus; metadata: Record<string, unknown>; created_at: string; updated_at: string }
  | { type: 'adi.knowledgebase_get_node'; id: string }
  | { type: 'adi.knowledgebase_get_node_response'; id: string; node_type: NodeType; title: string; content: string; source: string; approval_status: ApprovalStatus; metadata: Record<string, unknown>; created_at: string; updated_at: string }
  | { type: 'adi.knowledgebase_update_node'; id: string; title?: string; content?: string; node_type?: NodeType; metadata?: Record<string, unknown> }
  | { type: 'adi.knowledgebase_update_node_response'; id: string; node_type: NodeType; title: string; content: string; source: string; approval_status: ApprovalStatus; metadata: Record<string, unknown>; created_at: string; updated_at: string }
  | { type: 'adi.knowledgebase_delete_node'; id: string }
  | { type: 'adi.knowledgebase_delete_node_response'; deleted: boolean }
  | { type: 'adi.knowledgebase_list_nodes'; node_type?: NodeType; approval_status?: ApprovalStatus; source?: string; limit?: number; offset?: number }
  | { type: 'adi.knowledgebase_approve_node'; id: string }
  | { type: 'adi.knowledgebase_approve_node_response'; id: string; node_type: NodeType; title: string; content: string; source: string; approval_status: ApprovalStatus; metadata: Record<string, unknown>; created_at: string; updated_at: string }
  | { type: 'adi.knowledgebase_reject_node'; id: string; reason?: string }
  | { type: 'adi.knowledgebase_reject_node_response'; id: string; node_type: NodeType; title: string; content: string; source: string; approval_status: ApprovalStatus; metadata: Record<string, unknown>; created_at: string; updated_at: string }
