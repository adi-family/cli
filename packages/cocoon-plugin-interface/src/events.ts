...
import type { CocoonConnectionAddedEvent, CocoonConnectionRemovedEvent, CocoonSettingsChangedEvent } from './bus-keys';
...
declare module '@adi-family/sdk-plugin/types' {
  interface EventRegistry {
    ...
    'adi.cocoon:settings-changed': CocoonSettingsChangedEvent;
  }
}
