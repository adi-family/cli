      ...
      ">
        ...
        ">
          <svg
            ...
            style="width:calc(1rem * 2.5);height:calc(1rem * 2.5);"
          >
            <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
          </svg>
        </div>

        <div style="display:flex;flex-direction:column;gap:calc(1rem * 0.5);max-width:calc(1rem * 25);">
          <h2 style="
            font-size: calc(1rem * 1.953);
            font-weight: 600;
            color: var(--adi-text);
            margin: 0;
            line-height: 1.2;
