...
const SERVICE_ID: &str = "adi.i18n.workflow.de-DE";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new(
        "adi.workflow.de-DE",
        "ADI Workflow - Deutsch",
        "1.0.0",
        "translation",
    )
    .with_author("ADI Team")
    .with_description("Deutsche Übersetzungen für ADI Workflow")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.workflow.de-DE")
                .with_description("German translations for ADI Workflow");
        ...
        host.info("ADI Workflow German translation plugin initialized");
    }
