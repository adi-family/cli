//! German translation plugin for ADI Workflow (v3)
//!
...
pub struct GermanTranslationPlugin {
    metadata: TranslationMetadata,
}

impl GermanTranslationPlugin {
    pub fn new() -> Self {
        Self {
            metadata: TranslationMetadata {
...
#[async_trait]
impl Plugin for GermanTranslationPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            id: "adi.workflow.de-DE".to_string(),
            name: "ADI Workflow - Deutsch".to_string(),
            version: "3.0.0".to_string(),
            plugin_type: PluginType::Extension,
            author: Some("ADI Team".to_string()),
            description: Some("Deutsche Übersetzungen für ADI Workflow".to_string()),
            category: None,
        }
    }
...
impl Default for GermanTranslationPlugin {
    fn default() -> Self {
        Self::new()
    }
}
...
pub fn plugin_create() -> Box<dyn Plugin> {
    Box::new(GermanTranslationPlugin::new())
}
