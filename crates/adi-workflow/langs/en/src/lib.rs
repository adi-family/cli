...
const SERVICE_ID: &str = "adi.i18n.workflow.en-US";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new(
        "adi.workflow.en-US",
        "ADI Workflow - English",
        "1.0.0",
        "translation",
    )
    .with_author("ADI Team")
    .with_description("English translations for ADI Workflow")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.workflow.en-US")
                .with_description("English translations for ADI Workflow");
        ...
        host.info("ADI Workflow English translation plugin initialized");
    }
