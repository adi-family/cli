...
const SERVICE_ID: &str = "adi.i18n.workflow.ja-JP";
...
extern "C" fn plugin_info() -> PluginInfo {
    ...
    .with_description("ADI Workflow の日本語翻訳")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.workflow.ja-JP")
                .with_description("Japanese translations for ADI Workflow");
        ...
        host.info("ADI Workflow Japanese translation plugin initialized");
    }
