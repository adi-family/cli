...
const SERVICE_ID: &str = "adi.i18n.workflow.fr-FR";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new(
        "adi.workflow.fr-FR",
        "ADI Workflow - Français",
        "1.0.0",
        "translation",
    )
    .with_author("ADI Team")
    .with_description("Traductions françaises pour ADI Workflow")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.workflow.fr-FR")
                .with_description("French translations for ADI Workflow");
        ...
        host.info("ADI Workflow French translation plugin initialized");
    }
