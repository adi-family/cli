...
const SERVICE_ID: &str = "adi.i18n.workflow.ko-KR";
...
extern "C" fn plugin_info() -> PluginInfo {
    ...
    .with_description("ADI Workflow 한국어 번역")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.workflow.ko-KR")
                .with_description("Korean translations for ADI Workflow");
        ...
        host.info("ADI Workflow Korean translation plugin initialized");
    }
