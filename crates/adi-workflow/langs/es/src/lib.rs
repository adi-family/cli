...
const SERVICE_ID: &str = "adi.i18n.workflow.es-ES";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new(
        "adi.workflow.es-ES",
        "ADI Workflow - Español",
        "1.0.0",
        "translation",
    )
    .with_author("ADI Team")
    .with_description("Traducciones en español para ADI Workflow")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.workflow.es-ES")
                .with_description("Spanish translations for ADI Workflow");
        ...
        host.info("ADI Workflow Spanish translation plugin initialized");
    }
