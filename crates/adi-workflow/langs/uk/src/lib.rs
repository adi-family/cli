...
const SERVICE_ID: &str = "adi.i18n.workflow.uk-UA";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new(
        "adi.workflow.uk-UA",
        "ADI Workflow - Українська",
        "1.0.0",
        "translation",
    )
    .with_author("ADI Team")
    .with_description("Українські переклади для ADI Workflow")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.workflow.uk-UA")
                .with_description("Ukrainian translations for ADI Workflow");
        ...
        host.info("ADI Workflow Ukrainian translation plugin initialized");
    }
