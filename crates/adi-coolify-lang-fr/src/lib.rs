...
const SERVICE_ID: &str = "adi.i18n.coolify.fr-FR";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.coolify.fr-FR", "ADI Coolify - Français", "0.8.4", "translation")
        .with_author("ADI Team")
        .with_description("French translations for ADI Coolify plugin")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.coolify.fr-FR")
                .with_description("French translations for ADI Coolify");
        ...
        host.info("ADI Coolify French translations loaded");
    }
