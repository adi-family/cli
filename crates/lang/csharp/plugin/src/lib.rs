...
#[async_trait]
impl Plugin for CSharpAnalyzer {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("C# language parsing and analysis for ADI indexer".to_string()),
            category: None,
        }
    }
...
impl LanguageAnalyzer for CSharpAnalyzer {
    ...
    fn tree_sitter_language(&self) -> *const () {
        &tree_sitter_c_sharp::LANGUAGE as *const _ as *const ()
    }
}

#[no_mangle]
pub fn plugin_create() -> Box<dyn Plugin> {
    Box::new(CSharpAnalyzer)
}
