...
const SERVICE_ID: &str = "adi.i18n.coolify.ja-JP";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.coolify.ja-JP", "ADI Coolify - 日本語", "0.8.4", "translation")
        .with_author("ADI Team")
        .with_description("Japanese translations for ADI Coolify plugin")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.coolify.ja-JP")
                .with_description("Japanese translations for ADI Coolify");
        ...
        host.info("ADI Coolify Japanese translations loaded");
    }
