...
const SERVICE_ID: &str = "adi.i18n.coolify.de-DE";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.coolify.de-DE", "ADI Coolify - Deutsch", "0.8.4", "translation")
        .with_author("ADI Team")
        .with_description("German translations for ADI Coolify plugin")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.coolify.de-DE")
                .with_description("German translations for ADI Coolify");
        ...
        host.info("ADI Coolify German translations loaded");
    }
