...
const SERVICE_ID: &str = "adi.i18n.coolify.ko-KR";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.coolify.ko-KR", "ADI Coolify - 한국어", "0.8.4", "translation")
        .with_author("ADI Team")
        .with_description("Korean translations for ADI Coolify plugin")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.coolify.ko-KR")
                .with_description("Korean translations for ADI Coolify");
        ...
        host.info("ADI Coolify Korean translations loaded");
    }
