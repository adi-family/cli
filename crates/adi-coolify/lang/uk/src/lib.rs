...
const SERVICE_ID: &str = "adi.i18n.coolify.uk-UA";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.coolify.uk-UA", "ADI Coolify - Українська", "0.8.4", "translation")
        .with_author("ADI Team")
        .with_description("Ukrainian translations for ADI Coolify plugin")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.coolify.uk-UA")
                .with_description("Ukrainian translations for ADI Coolify");
        ...
        host.info("ADI Coolify Ukrainian translations loaded");
    }
