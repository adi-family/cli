...
const SERVICE_ID: &str = "adi.i18n.coolify.es-ES";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.coolify.es-ES", "ADI Coolify - Español", "0.8.4", "translation")
        .with_author("ADI Team")
        .with_description("Spanish translations for ADI Coolify plugin")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.coolify.es-ES")
                .with_description("Spanish translations for ADI Coolify");
        ...
        host.info("ADI Coolify Spanish translations loaded");
    }
