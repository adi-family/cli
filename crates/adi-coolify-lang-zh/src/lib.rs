...
const SERVICE_ID: &str = "adi.i18n.coolify.zh-CN";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.coolify.zh-CN", "ADI Coolify - 简体中文", "0.8.4", "translation")
        .with_author("ADI Team")
        .with_description("Chinese translations for ADI Coolify plugin")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        ...
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.coolify.zh-CN")
                .with_description("Chinese translations for ADI Coolify");
        ...
        host.info("ADI Coolify Chinese translations loaded");
    }
