//! Swift Language Support Plugin (v3)
//!
//! Language support for Swift with tree-sitter parsing 
...
pub struct SwiftLangPlugin;

#[async_trait]
impl Plugin for SwiftLangPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Language support for Swift with tree-sitter parsing ".to_string()),
        }
    }
...
#[async_trait]
impl CliCommands for SwiftLangPlugin {
