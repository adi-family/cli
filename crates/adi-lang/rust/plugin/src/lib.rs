//! Rust Language Support Plugin (v3)
//!
//! Language support for Rust with tree-sitter parsing 
...
#[async_trait]
impl Plugin for RustLangPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Language support for Rust with tree-sitter parsing ".to_string()),
        }
    }
...
#[async_trait]
impl CliCommands for RustLangPlugin {
