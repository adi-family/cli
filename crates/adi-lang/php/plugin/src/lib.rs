//! PHP Language Support Plugin (v3)
//!
//! Language support for PHP with tree-sitter parsing 
...
pub struct PhpLangPlugin;

#[async_trait]
impl Plugin for PhpLangPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Language support for PHP with tree-sitter parsing ".to_string()),
        }
    }
...
#[async_trait]
impl CliCommands for PhpLangPlugin {
