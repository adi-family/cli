...
impl Plugin for LuaAnalyzer {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Lua language parsing and analysis for ADI indexer".to_string()),
            category: None,
        }
    }
...
impl LanguageAnalyzer for LuaAnalyzer {
    ...
    fn tree_sitter_language(&self) -> *const () {
        &tree_sitter_lua::LANGUAGE as *const _ as *const ()
    }
}
