//! Lua Language Support Plugin (v3)
//!
//! Language support for Lua with tree-sitter parsing 
...
pub struct LuaLangPlugin;

#[async_trait]
impl Plugin for LuaLangPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            id: "adi.lang.lua".to_string(),
            name: "Lua Language Support".to_string(),
            version: env!("CARGO_PKG_VERSION").to_string(),
            plugin_type: PluginType::Core,
            author: Some("ADI Team".to_string()),
            description: Some("Language support for Lua with tree-sitter parsing ".to_string()),
        }
    }
...
#[async_trait]
impl CliCommands for LuaLangPlugin {
