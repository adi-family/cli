...
//!
//! Language support for C and C++ with tree-sitter parsing 
...
pub struct CppLangPlugin;

#[async_trait]
impl Plugin for CppLangPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Language support for C and C++ with tree-sitter parsing ".to_string()),
        }
    }
...
#[async_trait]
impl CliCommands for CppLangPlugin {
