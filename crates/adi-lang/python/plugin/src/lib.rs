//! Python Language Support Plugin (v3)
//!
//! Language support for Python with tree-sitter parsing 
...
pub struct PythonLangPlugin;

#[async_trait]
impl Plugin for PythonLangPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Language support for Python with tree-sitter parsing ".to_string()),
        }
    }
...
#[async_trait]
impl CliCommands for PythonLangPlugin {
