//! Java Language Support Plugin (v3)
//!
//! Language support for Java with tree-sitter parsing 
...
pub struct JavaLangPlugin;

#[async_trait]
impl Plugin for JavaLangPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Language support for Java with tree-sitter parsing ".to_string()),
        }
    }
...
#[async_trait]
impl CliCommands for JavaLangPlugin {
