//! ADI Audio Plugin (v3)
//!
//! Audio processing toolkit: WAV I/O, high-pass filter, parametric EQ, compression, loudness normalization 
...
impl Plugin for AudioPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: Some("Audio processing toolkit: WAV I/O, high-pass filter, parametric EQ, compression, loudness normalization ".to_string()),
        }
    }
