...
# Configuration
REGISTRY_URL=$(require_value "${ADI_REGISTRY_URL:-http://localhost:8019}" "ADI_REGISTRY_URL not set")
...
main() {
    ...
    require_file "$plugin_dir/plugin.toml"
    ...
    require_file "$plugin_lib" "Could not find built plugin library: $plugin_lib"
