...
get_plugin_crate() {
    ...
    case "$name" in
        ...
        lang-cpp) echo "crates/lang/cpp/plugin" ;;
        lang-csharp) echo "crates/lang/csharp/plugin" ;;
        lang-go) echo "crates/lang/go/plugin" ;;
        lang-java) echo "crates/lang/java/plugin" ;;
        lang-lua) echo "crates/lang/lua/plugin" ;;
        lang-php) echo "crates/lang/php/plugin" ;;
        lang-python) echo "crates/lang/python/plugin" ;;
        lang-ruby) echo "crates/lang/ruby/plugin" ;;
        lang-rust) echo "crates/lang/rust/plugin" ;;
        lang-swift) echo "crates/lang/swift/plugin" ;;
        lang-typescript) echo "crates/lang/typescript/plugin" ;;
        embed) echo "crates/embed-plugin" ;;
        audio) echo "crates/audio" ;;
