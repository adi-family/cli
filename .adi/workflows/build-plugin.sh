...
get_plugin_crate() {
    ...
    case "$name" in
        ...
        hive) echo "crates/hive/plugin" ;;
        agent-loop) echo "crates/agent-loop/plugin" ;;
        indexer) echo "crates/indexer/plugin" ;;
        knowledgebase) echo "crates/knowledgebase/plugin" ;;
        tasks) echo "crates/tasks/plugin" ;;
        ...
        lang-cpp) echo "crates/indexer/lang/cpp/plugin" ;;
        lang-csharp) echo "crates/indexer/lang/csharp/plugin" ;;
        lang-go) echo "crates/indexer/lang/go/plugin" ;;
        lang-java) echo "crates/indexer/lang/java/plugin" ;;
        lang-lua) echo "crates/indexer/lang/lua/plugin" ;;
        lang-php) echo "crates/indexer/lang/php/plugin" ;;
        lang-python) echo "crates/indexer/lang/python/plugin" ;;
        lang-ruby) echo "crates/indexer/lang/ruby/plugin" ;;
        lang-rust) echo "crates/indexer/lang/rust/plugin" ;;
        lang-swift) echo "crates/indexer/lang/swift/plugin" ;;
        lang-typescript) echo "crates/indexer/lang/typescript/plugin" ;;
        embed) echo "crates/embed-plugin" ;;
        audio) echo "../audio" ;;
        cli-lang-en) echo "crates/cli-lang-en" ;;
        # Hive plugins
