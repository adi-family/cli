...
- [`plugin-sdk`](docs/code-style/plugin-sdk.md): 
...
- [`rust-builder`](docs/code-style/rust-builder.md): Non-consuming (preferred): Methods take `&mut self`, return 
- [`rust-common-traits`](docs/code-style/rust-common-traits.md): 
- [`rust-coupling`](docs/code-style/rust-coupling.md): 
- [`rust-custom-types`](docs/code-style/rust-custom-types.md): 
- [`rust-documentation`](docs/code-style/rust-documentation.md): First line: Brief summary (appears in module/search listings
...
- [`rust-newtype`](docs/code-style/rust-newtype.md): 
